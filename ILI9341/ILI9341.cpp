...
ILI9341::ILI9341(int8_t dc, int8_t rst) : Adafruit_GFX(ILI9341_TFTWIDTH, ILI9341_TFTHEIGHT) {
  _dc   = dc;
  _rst  = rst;
  hwSPI = true;
#ifdef ESP8266
...
#ifdef ESP8266
void ILI9341::spiwrite16(uint16_t c) {
    SPI.write16(c, true);
}
#endif
...
void ILI9341::spiwriteBytes(uint8_t * data, uint8_t size) {
#ifdef ESP8266
...
void ILI9341::spiwritePattern(uint8_t * data, uint8_t size, uint32_t repeat) {
#ifdef ESP8266
...
inline void ILI9341::spiCsLow(void) {
...
inline void ILI9341::spiCsHigh(void) {
#ifdef ILI9341_USE_DIGITAL_WRITE
...
inline void ILI9341::spiDcLow(void){
#ifdef ILI9341_USE_DIGITAL_WRITE
...
inline void ILI9341::spiDcHigh(void) {
#ifdef ILI9341_USE_DIGITAL_WRITE
...
void ILI9341::writedata(uint8_t * data, uint8_t size) {
    spiDcHigh();
    spiCsLow();
...
void ILI9341::writeCmdData(uint8_t cmd, uint8_t * data, uint8_t size) {
    spiDcLow();
    spiCsLow();
...
void ILI9341::setAddrWindow_(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1) {
...
void ILI9341::pushColors(uint16_t* colors, uint32_t numColors) {
    if (hwSPI) spi_begin();
